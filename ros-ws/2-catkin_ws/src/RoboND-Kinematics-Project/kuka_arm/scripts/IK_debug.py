...
import tf
#from FK import rot_m, Tmatrix, invT
...
def test_code(test_case):
    ...
    ##
    pt = test_case[0][0]
    rpy = tf.euler_from_quaternion(test_case[0][1])
    ik_kuka.get_Rrpy(*rpy)
    ...
    your_ee = T[:3,3]  # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
