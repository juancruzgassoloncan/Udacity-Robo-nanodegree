...
class GetPathRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ignoreMe')) {
        this.ignoreMe = initObj.ignoreMe
      }
      else {
        this.ignoreMe = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ignoreMe]
    bufferOffset = _serializer.bool(obj.ignoreMe, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ignoreMe]
    data.ignoreMe = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.ignoreMe !== undefined) {
      resolved.ignoreMe = msg.ignoreMe;
    }
    else {
      resolved.ignoreMe = false
    }
...
module.exports = {
  ...
  md5sum() { return 'f65fd00b2e3f675220a83a94307b7f12'; },
  datatype() { return 'quad_controller/GetPath'; }
};
