...
class RoverState():
    def __init__(self):
        ...
        self.nav_angles = None  # Angles of navigable terrzain pixels
        ...
        self.brake_set = 5  # Brake zsetting when braking
...
go = Go(Rover)
rock = Rock(Rover)
stop = Stop(Rover, brake=Rover.brake_set)
stuck = Stuck(Rover)
home = ReturnHome(Rover)
search = SearchClearPath(Rover)
# states = [go, stop]
StateMachine = state_machine(Rover, home)
...
def telemetry(sid, data):
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            Rover = decision_step(Rover, StateMachine)
        ...
        # If you want to save camera images from autonomous driving specify a ppythonath
